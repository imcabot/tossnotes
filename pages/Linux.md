...
- ![image.png](https://flowus.cn/preview/5336a1a9-06b5-4d03-b616-89d1689e232b)
  id:: 636ce03e-fd7a-42e0-992d-9b3065d82de2
  
  ![image.png](https://flowus.cn/preview/a52c8e4d-466a-4572-9e16-35cae1b3df93)
## 计算机硬件组成
- 输入设备
...
- CPU（中央处理器）
	...
	- 运算器
		- 运算器主要运行算数运算和逻辑运算，并将中间结果暂存到运算器中
		      ...
		      ![image.png](https://flowus.cn/preview/151c27f4-3008-4893-b1c4-9e2ba41ee572)
## 硬盘的分类
- 硬盘按照存储介质的不同可以分为如下两种
	- 机械硬盘
		- 机械硬盘采用磁性碟片来存储数据
...
- 机械硬盘的数据读写
	- 主流的硬盘半机械半电子硬盘（机械硬盘）
		...
		- 数据传输时间
		      ...
		      ![image.png](https://flowus.cn/preview/2659e644-493e-4b94-b605-5a65a6cb8919)
## 顺序读写与随机读写
## 网络连接概念
- IP地址IPADDR
...
- Debain（免费）
	- Ubuntu
		...
		- 一些主流的软件都支持Ubuntu 系统
		      ...
		      ![image.png](https://flowus.cn/preview/9f00e65c-3d10-4434-9594-9895fe8f341d)
## Linux下载

![image.png](https://flowus.cn/preview/7dbc82dc-4c34-45d1-9885-86acfbbb03a7)
- 官网
