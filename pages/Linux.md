...
- CPU（中央处理器）
	...
	- 运算器
		- 运算器主要运行算数运算和逻辑运算，并将中间结果暂存到运算器中
		  ...
		  ![大图预览](https://cdn.flowus.cn/oss/686801a9-e021-4d93-8b90-30a3795cb318/image.png?filename=image.png&time=1668088333&token=5cc5daa920bca176c29d949e5aeba97b)
## 硬盘的分类
- 硬盘按照存储介质的不同可以分为如下两种
	- 机械硬盘
		- 机械硬盘采用磁性碟片来存储数据
